...
In order to try out ServiceInsight, an installation is required. The latest version can be downloaded [on our website](https://github.com/Particular/ServiceInsight/releases/tag/2.9.2). Once installed, ServiceInsight needs to be connected to ServiceControl. 
